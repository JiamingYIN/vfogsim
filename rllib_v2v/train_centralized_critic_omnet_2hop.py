...
from env import V2V_Env_ray_OMNET_2hop
...
if __name__ == '__main__':
    ...
    env = V2V_Env_ray_OMNET_2hop(configs['environment'])
    ...
    trainer = CentralizedCritic(config=ppo_config, env=V2V_Env_ray_OMNET_2hop)
