...
from env import V2V_Env_ray_OMNET_centralized
...
def load_config():
    with open(os.path.join('config', 'config_10agent.yaml'), 'r') as f:
...
if __name__ == '__main__':
    ...
    env = V2V_Env_ray_OMNET_centralized(configs['environment'])
    ...
    trainer = ppo.PPO(config=ppo_config, env=V2V_Env_ray_OMNET_centralized)
