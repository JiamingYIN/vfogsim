...
from env import V2V_Env_ray_OMNET
...
class CCA3CTorchPolicy(A3CTorchPolicy):
    def __init__(self, observation_space, action_space, config):
        A3CTorchPolicy.__init__(self, observation_space, action_space, config)
...
class CentralizedCritic(A3CTrainer):
    @override(A3CTrainer)
    def get_default_policy_class(self, config):
        print('CentralizedCritic!')
        return CCA3CTorchPolicy
...
if __name__ == '__main__':
    ...
    env = V2V_Env_ray_OMNET(configs['environment'])
    ...
    a3c_config = configs['A3C_config']
    a3c_config['env_config'] = configs['environment']
    a3c_config['multiagent'] = {
        "policies": policies,
        "policy_mapping_fn": policy_mapping_fn,
        # "policies_to_train": ["ppo_policy"]
    }
    a3c_config['model'] = {"custom_model": "torch_model"}
    a3c_config["disable_env_checking"] = True

    trainer = CentralizedCritic(env=V2V_Env_ray_OMNET, config=a3c_config)
